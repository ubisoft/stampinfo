...
class UAS_StampInfo_AddonErrorPrefs(AddonPreferences):
    ...
    def draw(self, context):
        ...
        doc_op = rowRight.operator("stampinfo.open_documentation_url", text="Stamp Info FAQ")
        doc_op.path = "https://ubisoft-stampinfo.readthedocs.io/en/latest/troubleshoot/faq.html#installation"
...
_classes = (UAS_StampInfo_AddonErrorPrefs,)
